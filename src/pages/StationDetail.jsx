  ...
  return (
    <div className="p-10 max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow p-6 border border-green-200 mb-8">
        <h2 className="text-2xl font-semibold text-green-700 mb-2">Location</h2>
      ...
      <div className="bg-white rounded-2xl shadow p-6 border border-green-200 mb-8">
        <h2 className="text-2xl font-semibold text-green-700 mb-4">Bee Statistics</h2>
      ...
      <div className="bg-white rounded-2xl shadow p-6 border border-green-200">
        <h2 className="text-2xl font-semibold text-green-700 mb-4">Tools</h2>

        <a href={station.cameraUrl || "#"} className="text-green-700 underline">
